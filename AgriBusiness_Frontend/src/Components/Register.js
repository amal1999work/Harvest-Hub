    ...
    <div className="register-page">
      <div className="register-container">
        <div className="image-container">
          <img src={`${process.env.PUBLIC_URL}/img/login/bag.jpg`} alt="Register" className="img-fluid" />
        </div>
        <div className="register-box">
          ...
          <form onSubmit={RegisterForm}>
            ...
            <div className="input-container">
              <label className="form-label" htmlFor="category">Category</label> <br/>
            ...
            {category === 'farmer' && (
              <div className="input-container">
                <label className="form-label" htmlFor="farmerImage">Upload Image</label>
                <input type="file" name="image" id="farmerImage" onChange={handleFileChange} />
              </div>
            )}

            <div className="input-container">
              <textarea name='address' placeholder="Address" onChange={(e) => setAddress(e.target.value)} />
            </div>
